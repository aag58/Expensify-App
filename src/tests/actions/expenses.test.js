...
import { startAddExpense ,addExpense, removeExpense, editExpenses, setExpenses, startSetExpenses, startRemoveExpenses} from '../../actions/expenses';
...
test('should remove expense from databse', (done)=>{
    const store = createMockStore({});
    const expense = expenses[2];
    store.dispatch(startRemoveExpenses(expense)).then(()=>{
